...
int main() {
    ...
    // Para cada atributo, queremos saber se a Carta 1 venceu (1) ou não (0)
    // Se Carta 1 > Carta 2: Carta 1 vence (1)
    // Se Carta 2 > Carta 1: Carta 2 vence (0)
    // Se empate: Considera-se que Carta 1 não venceu, então o resultado é (0)
